...
import { LayoutDashboard, Users, CreditCard, FileText, AudioLines, Settings, Shield, MessageCircle, X, Mic, Music } from "lucide-react";
...
const menuItems = [
  ...
  { path: "/admin/tracks", icon: Music, label: "Trilhas" },
];
